...
namespace HomebrewDot.Net.RimWorld.Comparing
{
    ...
    public interface IComparator
    {
        ...
        bool Compare(IConditionDef condition, IReadOnlyDictionary<string, object> context);
        /// <summary>
        ...
        bool Compare(IReadOnlyList<IConditionDef> conditions, IReadOnlyDictionary<string, object> context);
    }
}